...
interface CustomKeyProps<T = Record<string, unknown>> {
    nodeData: NodeData;
    name: string | number;
    path: CollectionKey[];
    value: JsonData;
...
interface CustomKeyDefinition<T = Record<string, unknown>> {
    condition: FilterFunction;
